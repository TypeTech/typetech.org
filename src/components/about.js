...
const About = () => {
  ...
  return (
    <section className={mode ? "Section-S-Dark" : "Section-S-Light"}>
      ...
      >
        <h2>
          <span className={mode ? "SpanHead-Dark" : "SpanHead-Light"}>
            Meet
          </span>
          <span className={mode ? "SpanHead-Dark" : "SpanHead-Light"}>
            {" "}
      ...
      <GridDiv>
        {TEAM.map(item => (
          <CardContainer key={item.name}>
            <div
              className={
                mode ? "Second-Card-Content-Dark" : "Second-Card-Content-Light"
              }
            >
              <h1>{item.name}</h1>
              <p>{item.title}</p>
              ...
              <InsideFooter>
                ...
                <SocialLinks>
                  <a href={item.website} aria-hidden="true">
                    <SVGs
                  ...
                  <a href={item.github} aria-hidden="true">
                    <SVGs
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
